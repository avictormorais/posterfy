...
`,Bn=({onRecreate:e})=>{const{t:a}=B(),[o,r]=d.useState(null),[n,s]=d.useState(!1),[l,h]=d.useState(!1),[c,p]=d.useState(null),[m,v]=d.useState(null);d.useEffect(()=>{const C=()=>{s(window.innerWidth<=770),h(window.innerWidth>480&&window.innerWidth<=1200)};return C(),window.addEventListener("resize",C),()=>window.removeEventListener("resize",C)},[]);const R=(C,b)=>{p(C),v(b),document.body.style.overflow="hidden"},x=()=>{p(null),document.body.style.overflow="auto"},f=()=>{p(null),e(m),document.body.style.overflow="auto"};return t.jsxs(t.Fragment,{children:[t.jsx(Vn,{children:An.map((C,b)=>t.jsx(Pn,{index:b,isHovered:o===b,hoveredIndex:o,otherIsHovered:o!==null,isMobile:n,isTablet:l,onMouseEnter:()=>r(b),onMouseLeave:()=>r(null),onClick:()=>R(C.coverImage||"/placeholder.svg",C.JSONConfig),children:t.jsx("img",{src:C.coverImage||"/placeholder.svg",alt:`${C.artist} - ${C.title}`})},C.id))}),c&&t.jsx($n,{onClick:x,children:t.jsxs(Hn,{onClick:C=>C.stopPropagation(),children:[t.jsxs(Dn,{children:[t.jsx(Fn,{onClick:x,children:"×"}),t.jsx(Nn,{onClick:f,children:a("RecreatePoster")})]}),t.jsx("img",{src:c,alt:"Album cover"})]})})]})},Gn=u.div`
  display: flex;
  width: 100%;
  justify-content: center;
  align-items: center;
...
`;function y3({DefaultColor:e,image:a,predefinedColors:o,position:r,onDone:n,onClose:s}){const[l,h]=d.useState(e),[c,p]=d.useState(!1),[m,v]=d.useState(null),R=d.useRef(null),x=d.useRef(null);function f(){p(!c)}function C(g){h(g.target.value===""?"#":g.target.value)}function b(g){const E=R.current,S=x.current.getBoundingClientRect(),k=E.getContext("2d"),_=Math.floor(g.clientX-S.left),I=Math.floor(g.clientY-S.top),L=`#${[...k.getImageData(_,I,1,1).data].slice(0,3).map(z=>z.toString(16).padStart(2,"0")).join("")}`;h(L),f()}function w(g){const E=R.current,S=x.current.getBoundingClientRect(),k=Math.floor(g.clientX-S.left),_=Math.floor(g.clientY-S.top);if(E){const I=E.getContext("2d");try{const L=`#${[...I.getImageData(k,_,1,1).data].slice(0,3).map(z=>z.toString(16).padStart(2,"0")).join("")}`;v(L)}catch{v(null)}}}function y(){v(null)}return t.jsxs(h3,{style:{position:"absolute",top:r.top,left:r.left,zIndex:1e3},children:[t.jsx("canvas",{ref:R,style:{display:"none"}}),c?t.jsx(b3,{ref:x,crossOrigin:"anonymous",draggable:"false",src:a,onClick:b,onMouseMove:w,onMouseLeave:y,onLoad:()=>{const g=R.current,E=g.getContext("2d"),M=x.current;g.width=M.width,g.height=M.height,E.drawImage(M,0,0,M.width,M.height)},style:m?{borderColor:m}:{}}):t.jsx(p3,{color:l,onChange:h}),t.jsx(z1,{children:o.map(g=>t.jsx(f3,{style:{backgroundColor:g},onClick:()=>h(g)},g))}),t.jsxs(z1,{children:[t.jsx(m3,{children:"Hex"}),t.jsx(g3,{value:l,onChange:C})]}),t.jsxs(z1,{children:[c?t.jsx(v3,{onClick:f}):t.jsx(x3,{onClick:f}),t.jsx(w3,{onClick:s}),t.jsx(C3,{onClick:()=>{n(l),Zo(l)}})]})]})}const j3=u.div`
    display: flex;
    flex-direction: column;
    margin: 10px;
`,E3=u.p`
...
`;function s2(){const{t:e}=B();return t.jsxs(G3,{children:[t.jsx(q3,{}),t.jsx(Y3,{children:e("Loading")}),t.jsx(U3,{children:e("LoadingText")})]})}var l2={},l1={},c2={exports:{}},W3="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",Z3=W3,Q3=Z3;function d2(){}function u2(){}u2.resetWarningCache=d2;var J3=function(){function e(r,n,s,l,h,c){if(c!==Q3){var p=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw p.name="Invariant Violation",p}}e.isRequired=e;function a(){return e}var o={array:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:a,element:e,elementType:e,instanceOf:a,node:e,objectOf:a,oneOf:a,oneOfType:a,shape:a,exact:a,checkPropTypes:u2,resetWarningCache:d2};return o.PropTypes=o,o};c2.exports=J3();var h2=c2.exports,nt={},c1={},p2={exports:{}};(function(e,a){(function(o,r){e.exports=r()})(J2,function(){var o=function(c,p){return c<p?-1:c>p?1:0},r=function(c){return c.reduce(function(p,m){return p+m},0)},n=function(){function c(m){this.colors=m}var p=c.prototype;return p.palette=function(){return this.colors},p.map=function(m){return m},c}(),s=function(){function c(x,f,C){return(x<<10)+(f<<5)+C}function p(x){var f=[],C=!1;function b(){f.sort(x),C=!0}return{push:function(w){f.push(w),C=!1},peek:function(w){return C||b(),w===void 0&&(w=f.length-1),f[w]},pop:function(){return C||b(),f.pop()},size:function(){return f.length},map:function(w){return f.map(w)},debug:function(){return C||b(),f}}}function m(x,f,C,b,w,y,g){var E=this;E.r1=x,E.r2=f,E.g1=C,E.g2=b,E.b1=w,E.b2=y,E.histo=g}function v(){this.vboxes=new p(function(x,f){return o(x.vbox.count()*x.vbox.volume(),f.vbox.count()*f.vbox.volume())})}function R(x,f){if(f.count()){var C=f.r2-f.r1+1,b=f.g2-f.g1+1,w=Math.max.apply(null,[C,b,f.b2-f.b1+1]);if(f.count()==1)return[f.copy()];var y,g,E,M,S=0,k=[],_=[];if(w==C)for(y=f.r1;y<=f.r2;y++){for(M=0,g=f.g1;g<=f.g2;g++)for(E=f.b1;E<=f.b2;E++)M+=x[c(y,g,E)]||0;k[y]=S+=M}else if(w==b)for(y=f.g1;y<=f.g2;y++){for(M=0,g=f.r1;g<=f.r2;g++)for(E=f.b1;E<=f.b2;E++)M+=x[c(g,y,E)]||0;k[y]=S+=M}else for(y=f.b1;y<=f.b2;y++){for(M=0,g=f.r1;g<=f.r2;g++)for(E=f.g1;E<=f.g2;E++)M+=x[c(g,E,y)]||0;k[y]=S+=M}return k.forEach(function(I,T){_[T]=S-I}),function(I){var T,L,z,V,P,O=I+"1",A=I+"2",H=0;for(y=f[O];y<=f[A];y++)if(k[y]>S/2){for(z=f.copy(),V=f.copy(),P=(T=y-f[O])<=(L=f[A]-y)?Math.min(f[A]-1,~~(y+L/2)):Math.max(f[O],~~(y-1-T/2));!k[P];)P++;for(H=_[P];!H&&k[P-1];)H=_[--P];return z[A]=P,V[O]=z[A]+1,[z,V]}}(w==C?"r":w==b?"g":"b")}}return m.prototype={volume:function(x){var f=this;return f._volume&&!x||(f._volume=(f.r2-f.r1+1)*(f.g2-f.g1+1)*(f.b2-f.b1+1)),f._volume},count:function(x){var f=this,C=f.histo;if(!f._count_set||x){var b,w,y,g=0;for(b=f.r1;b<=f.r2;b++)for(w=f.g1;w<=f.g2;w++)for(y=f.b1;y<=f.b2;y++)g+=C[c(b,w,y)]||0;f._count=g,f._count_set=!0}return f._count},copy:function(){var x=this;return new m(x.r1,x.r2,x.g1,x.g2,x.b1,x.b2,x.histo)},avg:function(x){var f=this,C=f.histo;if(!f._avg||x){var b,w,y,g,E=0,M=0,S=0,k=0;if(f.r1===f.r2&&f.g1===f.g2&&f.b1===f.b2)f._avg=[f.r1<<3,f.g1<<3,f.b1<<3];else{for(w=f.r1;w<=f.r2;w++)for(y=f.g1;y<=f.g2;y++)for(g=f.b1;g<=f.b2;g++)E+=b=C[c(w,y,g)]||0,M+=b*(w+.5)*8,S+=b*(y+.5)*8,k+=b*(g+.5)*8;f._avg=E?[~~(M/E),~~(S/E),~~(k/E)]:[~~(8*(f.r1+f.r2+1)/2),~~(8*(f.g1+f.g2+1)/2),~~(8*(f.b1+f.b2+1)/2)]}}return f._avg},contains:function(x){var f=this,C=x[0]>>3;return gval=x[1]>>3,bval=x[2]>>3,C>=f.r1&&C<=f.r2&&gval>=f.g1&&gval<=f.g2&&bval>=f.b1&&bval<=f.b2}},v.prototype={push:function(x){this.vboxes.push({vbox:x,color:x.avg()})},palette:function(){return this.vboxes.map(function(x){return x.color})},size:function(){return this.vboxes.size()},map:function(x){for(var f=this.vboxes,C=0;C<f.size();C++)if(f.peek(C).vbox.contains(x))return f.peek(C).color;return this.nearest(x)},nearest:function(x){for(var f,C,b,w=this.vboxes,y=0;y<w.size();y++)((C=Math.sqrt(Math.pow(x[0]-w.peek(y).color[0],2)+Math.pow(x[1]-w.peek(y).color[1],2)+Math.pow(x[2]-w.peek(y).color[2],2)))<f||f===void 0)&&(f=C,b=w.peek(y).color);return b},forcebw:function(){var x=this.vboxes;x.sort(function(w,y){return o(r(w.color),r(y.color))});var f=x[0].color;f[0]<5&&f[1]<5&&f[2]<5&&(x[0].color=[0,0,0]);var C=x.length-1,b=x[C].color;b[0]>251&&b[1]>251&&b[2]>251&&(x[C].color=[255,255,255])}},{quantize:function(x,f){if(!Number.isInteger(f)||f<1||f>256)throw new Error("Invalid maximum color count. It must be an integer between 1 and 256.");if(!x.length||f<2||f>256||!x.length||f<2||f>256)return!1;for(var C=[],b=new Set,w=0;w<x.length;w++){var y=x[w],g=y.join(",");b.has(g)||(b.add(g),C.push(y))}if(C.length<=f)return new n(C);var E=function(T){var L,z=new Array(32768);return T.forEach(function(V){L=c(V[0]>>3,V[1]>>3,V[2]>>3),z[L]=(z[L]||0)+1}),z}(x);E.forEach(function(){});var M=function(T,L){var z,V,P,O=1e6,A=0,H=1e6,W=0,te=1e6,ie=0;return T.forEach(function(Z){(z=Z[0]>>3)<O?O=z:z>A&&(A=z),(V=Z[1]>>3)<H?H=V:V>W&&(W=V),(P=Z[2]>>3)<te?te=P:P>ie&&(ie=P)}),new m(O,A,H,W,te,ie,L)}(x,E),S=new p(function(T,L){return o(T.count(),L.count())});function k(T,L){for(var z,V=T.size(),P=0;P<1e3;){if(V>=L||P++>1e3)return;if((z=T.pop()).count()){var O=R(E,z),A=O[0],H=O[1];if(!A)return;T.push(A),H&&(T.push(H),V++)}else T.push(z),P++}}S.push(M),k(S,.75*f);for(var _=new p(function(T,L){return o(T.count()*T.volume(),L.count()*L.volume())});S.size();)_.push(S.pop());k(_,f);for(var I=new v;_.size();)I.push(_.pop());return I}}}().quantize,l=function(c){this.canvas=document.createElement("canvas"),this.context=this.canvas.getContext("2d"),this.width=this.canvas.width=c.naturalWidth,this.height=this.canvas.height=c.naturalHeight,this.context.drawImage(c,0,0,this.width,this.height)};l.prototype.getImageData=function(){return this.context.getImageData(0,0,this.width,this.height)};var h=function(){};return h.prototype.getColor=function(c,p){return p===void 0&&(p=10),this.getPalette(c,5,p)[0]},h.prototype.getPalette=function(c,p,m){var v=function(C){var b=C.colorCount,w=C.quality;if(b!==void 0&&Number.isInteger(b)){if(b===1)throw new Error("colorCount should be between 2 and 20. To get one color, call getColor() instead of getPalette()");b=Math.max(b,2),b=Math.min(b,20)}else b=10;return(w===void 0||!Number.isInteger(w)||w<1)&&(w=10),{colorCount:b,quality:w}}({colorCount:p,quality:m}),R=new l(c),x=function(C,b,w){for(var y,g,E,M,S,k=C,_=[],I=0;I<b;I+=w)g=k[0+(y=4*I)],E=k[y+1],M=k[y+2],((S=k[y+3])===void 0||S>=125)&&(g>250&&E>250&&M>250||_.push([g,E,M]));return _}(R.getImageData().data,R.width*R.height,v.quality),f=s(x,v.colorCount);return f?f.palette():null},h.prototype.getColorFromUrl=function(c,p,m){var v=this,R=document.createElement("img");R.addEventListener("load",function(){var x=v.getPalette(R,5,m);p(x[0],c)}),R.src=c},h.prototype.getImageData=function(c,p){var m=new XMLHttpRequest;m.open("GET",c,!0),m.responseType="arraybuffer",m.onload=function(){if(this.status==200){var v=new Uint8Array(this.response);i=v.length;for(var R=new Array(i),x=0;x<v.length;x++)R[x]=String.fromCharCode(v[x]);var f=R.join(""),C=window.btoa(f);p("data:image/png;base64,"+C)}},m.send()},h.prototype.getColorAsync=function(c,p,m){var v=this;this.getImageData(c,function(R){var x=document.createElement("img");x.addEventListener("load",function(){var f=v.getPalette(x,5,m);p(f[0],this)}),x.src=R})},h})})(p2);var f2=p2.exports,d1={},it={};Object.defineProperty(it,"__esModule",{value:!0});it.default=K3;function K3(e,a,o){return`rgb(${e}, ${a}, ${o})`}var st={};Object.defineProperty(st,"__esModule",{value:!0});st.default=X3;function X3(e,a,o){return`#${[e,a,o].map(r=>{const n=r.toString(16);return n.length===1?`0${n}`:n}).join("")}`}Object.defineProperty(d1,"__esModule",{value:!0});d1.default=as;var es=m2(it),ts=m2(st);function m2(e){return e&&e.__esModule?e:{default:e}}function as(e,a){switch(a){case"rgbString":return(0,es.default)(e[0],e[1],e[2]);case"hex":return(0,ts.default)(e[0],e[1],e[2]);default:return e}}var u1={};Object.defineProperty(u1,"__esModule",{value:!0});u1.default=os;function os(e,a=void 0){return new Promise((o,r)=>{const n=new Image;n.addEventListener("load",()=>{o(n)}),n.addEventListener("error",()=>{r(new Error(`Failed to load image's URL: ${e}`))}),n.crossOrigin=a,n.src=e})}Object.defineProperty(c1,"__esModule",{value:!0});c1.default=ss;var rs=lt(f2),ns=lt(d1),is=lt(u1);function lt(e){return e&&e.__esModule?e:{default:e}}async function ss(e,a="rgbString",o=null,r=10){const n=await(0,is.default)(e,o),l=new rs.default().getColor(n,r);return(0,ns.default)(l,a)}Object.defineProperty(nt,"__esModule",{value:!0});nt.default=us;var l0=d,ls=cs(c1);function cs(e){return e&&e.__esModule?e:{default:e}}const g2={loading:!0,data:null,error:void 0};function ds(e,a){switch(a.type){case"getColor":return g2;case"resolveColor":return{...e,data:a.payload,loading:!1};case"rejectColor":return{...e,error:a.payload,loading:!1};default:return e}}function us(e,a="rgbString",o={}){const{crossOrigin:r=null,quality:n=10}=o,[s,l]=(0,l0.useReducer)(ds,g2);return(0,l0.useEffect)(()=>{l({type:"getColor"}),(0,ls.default)(e,a,r,n).then(h=>{l({type:"resolveColor",payload:h})}).catch(h=>{l({type:"rejectColor",payload:h})})},[e]),s}Object.defineProperty(l1,"__esModule",{value:!0});l1.default=void 0;var c0=ct(d),Se=ct(h2),hs=ct(nt);function ct(e){return e&&e.__esModule?e:{default:e}}const dt=({src:e,format:a,crossOrigin:o,quality:r,children:n})=>{const s=(0,hs.default)(e,a,{crossOrigin:o,quality:r});return c0.default.createElement(c0.default.Fragment,null,n(s))};dt.defaultProps={format:"rgbString",crossOrigin:null,quality:10};dt.propTypes={children:Se.default.any.isRequired,src:Se.default.string.isRequired,format:Se.default.oneOf(["rgbString","rgbArray","hex"]),crossOrigin:Se.default.string,quality:Se.default.number};var ps=dt;l1.default=ps;var h1={},ut={},p1={};Object.defineProperty(p1,"__esModule",{value:!0});p1.default=xs;var fs=ht(f2),ms=ht(d1),gs=ht(u1);function ht(e){return e&&e.__esModule?e:{default:e}}async function xs(e,a=2,o="rgbString",r=null,n=10){const s=await(0,gs.default)(e,r);return new fs.default().getPalette(s,a,n).map(c=>(0,ms.default)(c,o))}Object.defineProperty(ut,"__esModule",{value:!0});ut.default=bs;var d0=d,vs=ws(p1);function ws(e){return e&&e.__esModule?e:{default:e}}const x2={loading:!0,data:[],error:void 0};function Cs(e,a){switch(a.type){case"getPalette":return x2;case"resolvePalette":return{...e,data:a.payload,loading:!1};case"rejectPalette":return{...e,error:a.payload,loading:!1};default:return e}}function bs(e,a=2,o="rgbString",r={}){const{crossOrigin:n=null,quality:s=10}=r,[l,h]=(0,d0.useReducer)(Cs,x2);return(0,d0.useEffect)(()=>{h({type:"getPalette"}),(0,vs.default)(e,a,o,n,s).then(c=>{h({type:"resolvePalette",payload:c})}).catch(c=>{h({type:"rejectPalette",payload:c})})},[e]),l}Object.defineProperty(h1,"__esModule",{value:!0});h1.default=void 0;var u0=pt(d),pe=pt(h2),ys=pt(ut);function pt(e){return e&&e.__esModule?e:{default:e}}const ft=({src:e,colorCount:a,format:o,crossOrigin:r,quality:n,children:s})=>{const l=(0,ys.default)(e,a,o,{crossOrigin:r,quality:n});return u0.default.createElement(u0.default.Fragment,null,s(l))};ft.defaultProps={format:"rgbString",colorCount:2,crossOrigin:null,quality:10};ft.propTypes={children:pe.default.any.isRequired,src:pe.default.string.isRequired,format:pe.default.oneOf(["rgbString","rgbArray","hex"]),colorCount:pe.default.number,crossOrigin:pe.default.string,quality:pe.default.number};var js=ft;h1.default=js;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),Object.defineProperty(e,"Color",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(e,"Palette",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(e,"getColor",{enumerable:!0,get:function(){return r.default}}),Object.defineProperty(e,"getPalette",{enumerable:!0,get:function(){return n.default}}),e.default=void 0;var a=s(l1),o=s(h1),r=s(c1),n=s(p1);function s(h){return h&&h.__esModule?h:{default:h}}var l=a.default;e.default=l})(l2);const Es=(e,a=500,o=134)=>`
    ...
    `,Rs=({onImageReady:e,posterData:a,generatePoster:o,onTitleSizeAdjust:r,customFont:n})=>{const s=d.useRef(null);return d.useEffect(()=>{(async()=>{if(!o)return;const h=s.current,c=h.getContext("2d"),p=2480,m=3508;a.marginSide=parseInt(a.marginSide)||0,a.marginTop=parseInt(a.marginTop)||0,a.marginCover=parseInt(a.marginCover)||0,a.marginBackground=parseInt(a.marginBackground)||0;const v=async g=>{const E=new Image;return E.crossOrigin="anonymous",E.src=g,new Promise(M=>{E.onload=()=>{if(c.drawImage(E,a.marginCover,a.marginCover,p-a.marginCover*2,p-a.marginCover*2),a.useFade){let S=c.createLinearGradient(0,0,0,3e3-a.marginBackground);const k=C(a.backgroundColor);S.addColorStop(.5,`rgba(${k.r}, ${k.g}, ${k.b}, 0)`),S.addColorStop(.8,a.backgroundColor),c.fillStyle=S,c.fillRect(0,0,h.width,2500-a.marginBackground)}M()}})},R=async()=>{const g=Es(a.textColor,500,134),E=new Blob([g],{type:"image/svg+xml;charset=utf-8"}),M=URL.createObjectURL(E),S=new Image;return S.src=M,new Promise(k=>{S.onload=()=>{c.globalAlpha="0.5",c.drawImage(S,p-70-500,50,500,134),c.globalAlpha="1",URL.revokeObjectURL(M),k()}})},x=async()=>{let g=a.titleSize?parseInt(a.titleSize):230;const E=n||"Montserrat";if(!a.userAdjustedTitleSize&&!a.initialTitleSizeSet){c.font=`bold ${g}px ${E}`;let k=c.measureText(a.albumName).width;for(;k>2480-a.marginSide*2;)g-=1,c.font=`bold ${g}px ${E}`,k=c.measureText(a.albumName).width;r(g,!0)}else c.font=`bold ${g}px ${E}`;c.fillStyle=a.textColor,a.showTracklist?c.fillText(a.albumName,a.marginSide,2500+a.marginTop):c.fillText(a.albumName,a.marginSide,2790+a.marginTop);let M=a.artistsSize?parseInt(a.artistsSize):110;c.font=`bold ${M}px ${n||"Montserrat"}`,a.showTracklist?c.fillText(a.artistsName,a.marginSide,2500+a.marginTop+M*1.3):c.fillText(a.artistsName,a.marginSide,2820+a.marginTop+M),c.font=`bold 70px ${n||"Montserrat"}`,c.fillText(a.titleRelease,a.marginSide,3310);let S=c.measureText(a.titleRelease).width;c.fillText(a.titleRuntime,S+a.marginSide+100,3310),c.globalAlpha=.7,c.font=`bold 60px ${n||"Montserrat"}`,c.fillText(a.runtime,S+a.marginSide+100,3390),c.fillText(a.releaseDate,a.marginSide,3390),c.globalAlpha=1,c.fillStyle=a.color1,c.fillRect(2045-a.marginSide,3368,145,30),c.fillStyle=a.color2,c.fillRect(2190-a.marginSide,3368,145,30),c.fillStyle=a.color3,c.fillRect(2335-a.marginSide,3368,145,30)},f=async()=>{c.fillStyle=a.textColor;let g=a.marginSide+10,E=0,M=0;const S=a.tracksSize?parseInt(a.tracksSize):50;c.font=`bold ${S}px ${n||"Montserrat"}`;const k=S,_=parseInt(a.marginTop||0),I=parseInt(a.artistsSize)?2500+_+parseInt(a.artistsSize)*1.3+130:2500+_+110*1.2+130,T=500,L=p-a.marginSide*2,z=parseInt(a.marginSide),V=I+T-10-parseInt(a.marginTop);let P=I;a.tracklist.split(`
`).forEach(O=>{if(P+k*1.3>=V){if(P=I,g=E+k*2.5+M,g>=z+L)return;M=g-k*2.5,E=0}const A=c.measureText(`${O}`).width+a.marginSide;A>E&&(E=A),c.fillText(`${O}`,g,P),P+=k*1.3})},C=g=>{const E=parseInt(g.replace("#",""),16);return{r:E>>16&255,g:E>>8&255,b:E&255}},b=g=>{const E=S=>{const k=S/255;return k<=.03928?k/12.92:Math.pow((k+.055)/1.055,2.4)};return .2126*E(g.r)+.7152*E(g.g)+.0722*E(g.b)>.179?"black":"white"},w=async()=>{const g=C(a.backgroundColor),E=b(g),M=a.textColor,S=`https://scannables.scdn.co/uri/plain/svg/${a.backgroundColor.replace("#","")}/${E}/640/spotify:album:${a.albumID}`;let _=await(await fetch(S)).text();E=="black"?_=_.replace(/fill="#000000"/g,`fill="${M}"`):_=_.replace(/fill="#ffffff"/g,`fill="${M}"`),_=_.replace(a.backgroundColor,"transparent");const I=new Blob([_],{type:"image/svg+xml"}),T=URL.createObjectURL(I);return new Promise(L=>{const z=new Image;z.src=T,z.onload=function(){c.drawImage(z,2020-a.marginSide,3235,480,120);const V=h.toDataURL("image/png");e(V),L()}})},y=async()=>{c.fillStyle=a.backgroundColor,c.fillRect(0,2480-a.marginBackground,p,m-2480+a.marginBackground)};c.clearRect(0,0,p,m),c.fillStyle=a.backgroundColor,c.fillRect(0,0,p,m),a.useUncompressed?await v(await a.uncompressedAlbumCover):await v(a.albumCover),await y(),await x(),a.showTracklist&&await f(),a.useWatermark&&await R(),await w()})()},[o,a,e]),t.jsx("canvas",{ref:s,width:2480,height:3508,style:{display:"none"}})},Ss=u.div`
    opacity: ${e=>e.visible?1:0};
    transform: translateY(${e=>e.visible?"0":"20px"});
    transition: opacity 0.5s ease, transform 0.5s ease;
    transition-delay: ${e=>e.animationDelay||0}ms;
...
`,vl=u.div`
    ...
    margin-top: 20px;
    margin-inline: auto;
`;function g0({query:e,onclick:a}){const{t:o}=B(),[r,n]=d.useState([]),[s,l]=d.useState(""),[h,c]=d.useState(0),[p,m]=d.useState(!0),[v,R]=d.useState(!1),[x,f]=d.useState(!1),C=20;d.useEffect(()=>{(async()=>{const M=await(await fetch("https://accounts.spotify.com/api/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded",Authorization:`Basic ${btoa("f4cecfcee6bb4476a132ecef4b321cde:eca60833bc674b718879e122402968fc")}`},body:"grant_type=client_credentials"})).json();l(M.access_token)})()},[]),d.useEffect(()=>{n([]),c(0),m(!0)},[e]),d.useEffect(()=>{const w=async(y=!1)=>{if(s){y?f(!0):R(!0);try{let g;const E=y?h:0;if(e?g=await fetch(`https://api.spotify.com/v1/search?q=${encodeURIComponent(e)}&type=album&limit=${C}&offset=${E}`,{headers:{Authorization:`Bearer ${s}`}}):g=await fetch(`https://api.spotify.com/v1/browse/new-releases?offset=${E}&limit=${C}&locale=en-US`,{headers:{Authorization:`Bearer ${s}`}}),!g.ok){const T=await g.text();throw new Error(`Erro na API: ${T}`)}const M=await g.json(),k=M.albums.items.filter(T=>T!=null).map(T=>{var L,z;return{id:T.id,title:T.name,artist:(L=T.artists)==null?void 0:L.map(V=>V.name).join(", "),cover:(z=T.images[0])==null?void 0:z.url}});n(y?T=>[...T,...k]:k);const _=M.albums.total,I=y?r.length+k.length:k.length;m(I<_&&k.length===C)}catch(g){console.error(g)}finally{R(!1),f(!1)}}};s&&(r.length===0||h===0)&&w(!1)},[e,s]);const b=async()=>{if(!s||!p||x)return;const w=h+C;c(w);try{f(!0);let y;if(e?y=await fetch(`https://api.spotify.com/v1/search?q=${encodeURIComponent(e)}&type=album&limit=${C}&offset=${w}`,{headers:{Authorization:`Bearer ${s}`}}):y=await fetch(`https://api.spotify.com/v1/browse/new-releases?offset=${w}&limit=${C}&locale=en-US`,{headers:{Authorization:`Bearer ${s}`}}),!y.ok){const _=await y.text();throw new Error(`Erro na API: ${_}`)}const g=await y.json(),M=g.albums.items.filter(_=>_!=null).map(_=>{var I,T;return{id:_.id,title:_.name,artist:(I=_.artists)==null?void 0:I.map(L=>L.name).join(", "),cover:(T=_.images[0])==null?void 0:T.url}});n(_=>[..._,...M]);const S=g.albums.total,k=r.length+M.length;m(k<S&&M.length===C)}catch(y){console.error(y)}finally{f(!1)}};return t.jsx(t.Fragment,{children:v&&r.length===0?t.jsx(s2,{}):t.jsxs(t.Fragment,{children:[t.jsx(gl,{children:r.map((w,y)=>t.jsx(ml,{onClick:()=>a(w.id),cover:w.cover,title:w.title,artist:w.artist,id:w.id,animationDelay:y-h*100},w.id))}),p&&t.jsx(vl,{children:t.jsx(xl,{onClick:b,disabled:x,children:o(x?"LoadingMore":"LoadMore")})})]})})}const wl=({onBack:e})=>{const[a,o]=d.useState(""),[r,n]=d.useState(null),[s,l]=d.useState(!1),[h,c]=d.useState(null),[p,m]=d.useState(null),v=d.useRef(null);d.useEffect(()=>{s&&r&&v.current&&setTimeout(()=>{v.current.scrollIntoView({behavior:"smooth",block:"start"})},100)},[s,r]);function R(C){n(C),l(!0),c(null),m(null)}function x(){n(null),l(!1),c(null),m(null),e&&e()}const f=C=>{o(C)};return r&&h&&p?t.jsx(mt,{albumID:r,handleClickBack:x,model:h,modelParams:p,source:"search_creation"}):r&&s?t.jsx("div",{ref:v,children:t.jsx(al,{onSelectModel:(C,b)=>{c(C),m(b),l(!1)},onBack:x})}):t.jsxs(t.Fragment,{children:[t.jsx(cl,{onSearch:f,value:a}),a.trim()?t.jsx(g0,{query:a,onclick:R}):t.jsx("div",{children:t.jsx(g0,{onclick:R})})]})};function Cl({loadingComplete:e}){const{t:a}=B(),[o,r]=d.useState(null),n=d.useRef(null),s=h=>{Jo(h.albumName||"Unknown Album",h.artistsName||"Unknown Artist",h.albumID||"","album_collection"),r(h),setTimeout(()=>{if(n.current){const c=n.current.getBoundingClientRect().top+window.pageYOffset-80;window.scrollTo({top:c,behavior:"smooth"})}},100)},l=()=>{r(null)};return t.jsxs(t.Fragment,{children:[t.jsx(Kn,{showAnimation:e,onRecreate:s}),t.jsx(ze,{text:a("anchorArt"),type:1}),t.jsx(ot,{title:a("ArtTitle"),paragraph:a("ArtParagraph")}),o?t.jsx(mt,{ref:n,albumID:o.albumID,initialPosterJson:o,handleClickBack:l}):t.jsx(wl,{}),t.jsx(Si,{}),t.jsx(Ci,{}),t.jsx(fi,{}),t.jsx($i,{})]})}function bl(e){return $({attr:{version:"1.1",x:"0px",y:"0px",viewBox:"0 0 48 48",enableBackground:"new 0 0 48 48"},child:[{tag:"path",attr:{fill:"#FFC107",d:`M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12\r
