...
`;function fl({albumID:e,handleClickBack:t}){const{t:n}=J(),u=g.useRef(null),[r,a]=g.useState(""),[o,s]=g.useState(""),[l,d]=g.useState("200"),[f,p]=g.useState("110"),[x,_]=g.useState("50"),[v,m]=g.useState(""),[w,C]=g.useState(160),[T,b]=g.useState(0),[k,I]=g.useState("#5900ff"),[j,S]=g.useState("#ff9100"),[R,O]=g.useState("#ff0000"),[D,M]=g.useState("#00ff40"),[z,$]=g.useState("#2600ff"),[U,B]=g.useState(!0),[H,N]=g.useState(!0),[Z,_t]=g.useState(!1),[ne,Ct]=g.useState(""),[Be,kt]=g.useState(""),[rn,nn]=g.useState(""),[ee,on]=g.useState(null),[qe,Tt]=g.useState("information");g.useEffect(()=>{if(ee){const y=new FileReader;y.onload=async E=>{const F="CustomFont",X=new FontFace(F,E.target.result);try{const G=await X.load();document.fonts.add(G),nn(F)}catch(G){console.error("Erro ao carregar fonte:",G)}},y.readAsArrayBuffer(ee)}},[ee]);const[Ue,He]=g.useState(!1),[an,sn]=g.useState("Original"),[fe,he]=g.useState(""),[jt,It]=g.useState(""),[St,Rt]=g.useState(""),[Et,Ot]=g.useState(""),[At,Dt]=g.useState(""),[ln,Pt]=g.useState(!1),[zt,Mt]=g.useState(null),[te,cn]=g.useState(null),[$t,Ft]=g.useState(!1),[Lt,un]=g.useState(!1),dn=y=>{d(y.target.value),Ft(!0)},fn=(y,E)=>{E&&!Lt?(d(y),un(!0)):$t||d(y)},hn={albumCover:ne,uncompressedAlbumCover:Be,useUncompressed:Ue,albumName:r,artistsName:o,titleSize:l,artistsSize:f,tracksSize:x,marginTop:v,marginSide:w,marginCover:T,titleRelease:jt,releaseDate:St,titleRuntime:Et,runtime:At,backgroundColor:k,textColor:j,useWatermark:U,useFade:H,showTracklist:Z,tracklist:fe,color1:R,color2:D,color3:z,albumID:e,userAdjustedTitleSize:$t,initialTitleSizeSet:Lt},[oe,pn]=g.useState(null),[Qe,Bt]=g.useState(!1),[mn,Ne]=g.useState(!1),[gn,xn]=g.useState(!1),[vn,qt]=g.useState(!1),[bn,Ge]=g.useState(!1);g.useEffect(()=>{if(Qe){Ne(!1);const y=setTimeout(()=>{Ge(!0)},100);return()=>clearTimeout(y)}else Ge(!1)},[Qe]);const yn=y=>{pn(y),Bt(!1),qt(!1),setTimeout(()=>{Ge(!1),setTimeout(()=>{Ne(!0)},300)},100)},We=()=>{Ft(!1),Ne(!1),requestAnimationFrame(()=>{if(qt(!0),Bt(!0),u.current){const y=u.current.getBoundingClientRect(),E=y.top+window.scrollY,F=y.height,G=(window.innerHeight-F)/2;window.scrollTo({top:E-G,behavior:"smooth"})}})},wn=y=>{Ct(URL.createObjectURL(y)),He(!1),kt(""),sn(y.name)},Ve=()=>{if(!oe)return;const y=document.createElement("a");y.href=oe,y.download=`Posterfy - ${r}.png`,y.click(),Je(r,"poster")},_n=async()=>{if(Ue){if(!Be)return;const y=await(await fetch(await Be)).blob(),E=Object.assign(document.createElement("a"),{href:URL.createObjectURL(y),download:`Posterfy - ${r} Uncompressed Cover.png`});E.click(),URL.revokeObjectURL(E.href),Je(r,"uncompressed_cover")}else{if(!ne)return;const y=await(await fetch(ne)).blob(),E=Object.assign(document.createElement("a"),{href:URL.createObjectURL(y),download:`Posterfy - ${r} Cover.png`});E.click(),URL.revokeObjectURL(E.href),Je(r,"cover")}};function ie(y,E){const F=y.target.getBoundingClientRect();Mt({top:F.top+window.scrollY,left:F.left+window.scrollX}),cn(E),Pt(!0)}function Cn(){Pt(!1)}const kn=()=>{const E=fe.split(`
`).map(F=>F.replace(/\([^)]*\)/g,"").replace(/\s+/g," ").trim());he(E.join(`
`))},Tn=()=>{const E=fe.split(`
`).map(F=>F.replace(/\[[^\]]*\]/g,"").replace(/\s+/g," ").trim());he(E.join(`
`))};async function jn(y,E="us"){var F;try{let X=`https://itunes.apple.com/search?term=${encodeURIComponent(y)}&country=${E}&entity=album&limit=1`,G=await fetch(X);if(!G.ok)throw new Error(`HTTP Error: ${G.status}`);let Ye=await G.json();if(!((F=Ye.results)!=null&&F.length))return console.warn("No album data found."),He(!1),"";let W=Ye.results[0].artworkUrl100.replace("100x100bb","100000x100000-999").split("/image/thumb/");return W.length===2?`https://a5.mzstatic.com/us/r1000/0/${W[1].split("/").slice(0,-1).join("/")}`:""}catch(X){return console.error("Error fetching album cover:",X.message),""}}return g.useEffect(()=>{It(n("EDITOR_ReleaseTitle")),Ot(n("EDITOR_RuntimeTitle"))},[n]),g.useEffect(()=>{e&&(async()=>{var E;try{const Ut=(await(await fetch("https://accounts.spotify.com/api/token",{method:"POST",headers:{Authorization:`Basic ${btoa("f4cecfcee6bb4476a132ecef4b321cde:eca60833bc674b718879e122402968fc")}`,"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"client_credentials"})})).json()).access_token,W=await(await fetch(`https://api.spotify.com/v1/albums/${e}`,{headers:{Authorization:`Bearer ${Ut}`}})).json(),Ke=W.artists.map(ae=>ae.name).join(", ");a(W.name),s(Ke),Ct((E=W.images[0])==null?void 0:E.url),Rt(W.release_date),kt(await jn(W.name+" "+Ke));const Sn=W.tracks.items.reduce((ae,pe)=>ae+pe.duration_ms,0),Ht=Math.floor(Sn/1e3),Qt=Math.floor(Ht/60),Nt=Math.floor(Qt/60),Gt=Ht%60,Wt=Qt%60,Rn=Nt>0?`${Nt}h ${Wt}min ${Gt}s`:`${Wt}min ${Gt}s`;Dt(Rn);const En=W.tracks.items.map((ae,pe)=>(pe==3&&_t(!0),`${pe+1}. ${ae.name}`));he(En.join(`
`)),xn(!0)}catch(F){console.error("Error trying to fetch album data:",F)}})()},[e]),g.useEffect(()=>{const y=E=>{E.ctrlKey&&E.key==="s"?(E.preventDefault(),We()):E.ctrlKey&&E.key==="d"&&(E.preventDefault(),Ve())};return window.addEventListener("keydown",y),()=>{window.removeEventListener("keydown",y)}},[oe,r,Ve]),c.jsx(c.Fragment,{children:gn?c.jsxs(Vs,{children:[c.jsx(tn,{src:ne,crossOrigin:"anonymous",format:"hex",colorCount:5,children:({data:y})=>(g.useEffect(()=>{y&&y.length>0&&(I(y[0]),S(y[1]),O(y[2]),M(y[3]),$(y[4]),We())},[y]),null)}),c.jsxs(Ys,{onClick:t,children:[c.jsx(Ks,{}),c.jsx(Js,{children:n("GoBack")})]}),c.jsxs(Xs,{children:[c.jsx(Gs,{onImageReady:yn,posterData:hn,generatePoster:Qe,onTitleSizeAdjust:fn,customFont:rn}),c.jsxs(el,{children:[oe?c.jsx(Zs,{src:oe,ref:u,visible:mn}):c.jsx(ul,{ref:u}),c.jsx(tl,{visible:bn})]}),c.jsxs(rl,{children:[c.jsx(A,{animationDelay:50,children:c.jsxs(nl,{children:[c.jsx(Sr,{$active:qe==="information",onClick:()=>Tt("information"),children:n("EDITOR_InformationTab")}),c.jsx(Sr,{$active:qe==="tracklist",onClick:()=>Tt("tracklist"),children:n("EDITOR_TracklistTab")})]})}),qe==="information"?c.jsxs(ol,{children:[c.jsx(A,{animationDelay:0,children:c.jsx(K,{title:n("EDITOR_AlbumName"),value:r,onChange:y=>a(y.target.value)})}),c.jsx(A,{animationDelay:50,children:c.jsx(K,{title:n("EDITOR_ArtistName"),value:o,onChange:y=>s(y.target.value)})}),c.jsx(A,{animationDelay:100,children:c.jsx(K,{title:n("EDITOR_TitleSize"),value:l,onChange:dn})}),c.jsx(A,{animationDelay:150,children:c.jsx(K,{title:n("EDITOR_ArtistSize"),value:f,onChange:y=>p(y.target.value)})}),c.jsx(A,{animationDelay:200,children:c.jsx(K,{title:n("EDITOR_TracksSize"),value:x,onChange:y=>_(y.target.value)})}),c.jsx(A,{animationDelay:250,children:c.jsx(K,{title:n("EDITOR_MarginTop"),value:v,onChange:y=>m(y.target.value)})}),c.jsx(A,{animationDelay:300,children:c.jsx(K,{title:n("EDITOR_MarginSide"),value:w,onChange:y=>C(y.target.value)})}),c.jsx(A,{animationDelay:350,children:c.jsx(K,{title:n("EDITOR_MarginCover"),value:T,onChange:y=>b(y.target.value)})}),c.jsx(A,{animationDelay:400,children:c.jsx(rr,{title:jt,value:St,onChangeTitle:y=>It(y.target.value),onChangeDate:y=>Rt(y.target.value)})}),c.jsx(A,{animationDelay:450,children:c.jsx(rr,{title:Et,value:At,onChangeTitle:y=>Ot(y.target.value),onChangeDate:y=>Dt(y.target.value)})}),c.jsx(A,{animationDelay:500,children:c.jsx(le,{title:n("EDITOR_BackgroundColor"),value:k,onClick:y=>ie(y,"backgroundColor")})}),c.jsx(A,{animationDelay:550,children:c.jsx(le,{title:n("EDITOR_TextColor"),value:j,onClick:y=>ie(y,"textColor")})}),c.jsx(A,{animationDelay:600,children:c.jsx(le,{title:`${n("EDITOR_Color")} 1`,value:R,onClick:y=>ie(y,"color1")})}),c.jsx(A,{animationDelay:650,children:c.jsx(le,{title:`${n("EDITOR_Color")} 2`,value:D,onClick:y=>ie(y,"color2")})}),c.jsx(A,{animationDelay:700,children:c.jsx(le,{title:`${n("EDITOR_Color")} 3`,value:z,onClick:y=>ie(y,"color3")})}),c.jsx(A,{animationDelay:750,children:c.jsx(be,{title:n("EDITOR_Watermark"),value:U,onChange:y=>B(y),text:n("EDITOR_WatermarkText")})}),c.jsx(A,{animationDelay:800,children:c.jsx(be,{title:n("EDITOR_Fade"),value:H,onChange:y=>N(y),text:n("EDITOR_FadeText")})}),c.jsx(A,{animationDelay:850,children:c.jsx(be,{title:n("EDITOR_Uncompressed"),value:Ue,onChange:y=>He(y),text:n("EDITOR_UncompressedText")})}),c.jsx(A,{animationDelay:900,children:c.jsx(be,{title:n("EDITOR_Tracklist"),value:Z,onChange:y=>_t(y),text:n("EDITOR_TracklistText")})}),c.jsx(A,{animationDelay:950,children:c.jsx(Xa,{title:n("EDITOR_Cover"),onChange:wn,text:an})}),c.jsx(A,{animationDelay:1e3,children:c.jsx(is,{title:n("EDITOR_Font"),text:(ee==null?void 0:ee.name)||n("EDITOR_DefaultFont"),onChange:on})}),ln&&zt&&te&&c.jsx(Fa,{DefaultColor:te==="backgroundColor"?k:te==="textColor"?j:te==="color1"?R:te==="color2"?D:z,image:ne,predefinedColors:[R,D,z,k,j],onDone:y=>{switch(te){case"backgroundColor":I(y);break;case"textColor":S(y);break;case"color1":O(y);break;case"color2":M(y);break;case"color3":$(y);break}Mt(null)},position:zt,onClose:Cn})]}):c.jsxs(il,{children:[c.jsx(sl,{value:fe,onChange:y=>he(y.target.value),placeholder:n("EDITOR_TracklistPlaceholder")}),c.jsxs(al,{children:[c.jsx(Rr,{onClick:kn,children:n("EDITOR_RemoveParentheses")}),c.jsx(Rr,{onClick:Tn,children:n("EDITOR_RemoveBrackets")})]})]}),c.jsx(A,{animationDelay:1050,children:c.jsxs(ll,{children:[c.jsxs(at,{onClick:_n,children:[c.jsx(Er,{}),c.jsx(st,{children:n("EDITOR_DownloadCover")})]}),c.jsxs(at,{onClick:Ve,children:[c.jsx(Er,{}),c.jsx(st,{children:n("EDITOR_Download")})]}),c.jsxs(at,{onClick:We,children:[c.jsx(cl,{$spinning:vn}),c.jsx(st,{children:n("EDITOR_Apply")})]})]})}),c.jsx(A,{animationDelay:1100,children:c.jsxs(dl,{children:[n("EDITOR_Shortcuts"),": Ctrl+S (",n("EDITOR_Apply"),"), Ctrl+D (",n("EDITOR_Download"),")"]})})]})]})]}):c.jsx(Lr,{})})}const Or=e=>{if(!e)return"";const n=(e.replace(/\/$/,"")||"/").split("/");return n.length>2&&(n[2]=n[2].toLowerCase()),n.join("/")},wt=()=>"https://posterfy.space"+"/",hl=e=>{const t=wt(),n=Or(e),u=Or(t),r=e.includes("://www."),a=e.startsWith("http://");return r||a||n!==u},pl=()=>{const e=window.location.href,t=wt(),n=[];return hl(e)&&n.push({type:"redirect_needed",current:e,canonical:t,message:"Current URL should redirect to canonical URL"}),{isValid:n.length===0,issues:n,currentUrl:e,canonicalUrl:t}},ml=({title:e="Posterfy - Free Album Poster Generator | Create Custom Music Posters Online",description:t="Create stunning album posters for free with Posterfy. Design custom music posters from Spotify albums with professional templates. Best album poster generator online - no signup required!",keywords:n="album poster generator, music poster maker, spotify poster, album cover poster, custom music posters, free poster generator, album art poster, music poster design, posterfy"})=>(g.useEffect(()=>{const r="https://posterfy.space",a=wt(),o=r+"/albuns.png";document.title=e;const s=document.querySelector('meta[name="description"]');s&&s.setAttribute("content",t);const l=document.querySelector('meta[name="keywords"]');l&&l.setAttribute("content",n);let d=document.querySelector('link[rel="canonical"]');d?d.setAttribute("href",a):(d=document.createElement("link"),d.setAttribute("rel","canonical"),d.setAttribute("href",a),document.head.appendChild(d));const f=document.querySelector('meta[property="og:title"]');f&&f.setAttribute("content",e);const p=document.querySelector('meta[property="og:description"]');p&&p.setAttribute("content",t);const x=document.querySelector('meta[property="og:image"]');x&&x.setAttribute("content",o);const _=document.querySelector('meta[property="og:url"]');_&&_.setAttribute("content",a);const v=document.querySelector('meta[name="twitter:title"]');v&&v.setAttribute("content",e);const m=document.querySelector('meta[name="twitter:description"]');m&&m.setAttribute("content",t);const w=document.querySelector('meta[name="twitter:image"]');w&&w.setAttribute("content",o);const C={"@context":"https://schema.org","@type":"WebPage",name:e,description:t,url:a,mainEntity:{"@type":"WebApplication",name:"Posterfy",applicationCategory:"DesignApplication",operatingSystem:"Web Browser",url:r+"/",description:t,offers:{"@type":"Offer",price:"0",priceCurrency:"USD"}}},T=document.querySelector('script[type="application/ld+json"]#dynamic-structured-data');T&&T.remove();const b=document.createElement("script");b.type="application/ld+json",b.id="dynamic-structured-data",b.innerHTML=JSON.stringify(C),document.head.appendChild(b)},[e,t,n]),null),gl=()=>(g.useEffect(()=>{setTimeout(()=>{const n=[],u=document.querySelector('link[rel="canonical"]');(!u||!u.href)&&n.push("Missing canonical URL");const r=document.querySelector('meta[name="description"]');(!r||r.content.length<120)&&n.push("Meta description too short or missing"),(!document.title||document.title.length<30)&&n.push("Title too short or missing");const a=pl();a.isValid||a.issues.forEach(l=>{n.push(`${l.type}: ${l.message}`)});const o=document.querySelector('meta[name="robots"]');return o&&o.content.includes("noindex")&&n.push("Page marked as noindex"),document.querySelector('script[type="application/ld+json"]')||n.push("Missing structured data"),n},1e3),(()=>{const n=window.location.href;n.includes("www.")||n.startsWith("http://")})()},[]),null),xl=()=>(g.useEffect(()=>{Gn()},[]),null),vl=()=>{g.useEffect(()=>{Kt(document.title,window.location.href);const e=new MutationObserver(n=>{n.forEach(u=>{u.type==="childList"&&u.target.nodeName==="TITLE"&&Kt(document.title,window.location.href)})}),t=document.querySelector("title");return t&&e.observe(t,{childList:!0,subtree:!0}),()=>{e.disconnect()}},[])};function bl(){const{t:e}=J(),[t,n]=g.useState(!0),[u,r]=g.useState(!1),[a,o]=g.useState(""),[s,l]=g.useState(null);vl(),g.useEffect(()=>Ro(),[]);function d(x){l(x)}function f(){l(null)}g.useEffect(()=>{const x=setTimeout(()=>{n(!1),setTimeout(()=>{r(!0)},1e3)},1100);return()=>clearTimeout(x)},[]),g.useEffect(()=>(t?document.body.style.overflow="hidden":document.body.style.overflow="unset",()=>{document.body.style.overflow="unset"}),[t]);const p=x=>{o(x)};return c.jsxs(Eo,{children:[c.jsx(ml,{}),c.jsx(gl,{}),c.jsx(xl,{}),c.jsx(co,{}),c.jsx(Mo,{showAnimation:u}),c.jsx(ct,{text:e("anchorArt"),type:1}),c.jsx(Uo,{title:e("ArtTitle"),paragraph:e("ArtParagraph")}),s?c.jsx(fl,{albumID:s,handleClickBack:f}):c.jsxs(c.Fragment,{children:[c.jsx(si,{onSearch:p,value:a}),a&&c.jsx(tr,{query:a,onclick:d}),c.jsxs("div",{style:{display:a?"none":"block"},children:[c.jsx(ct,{text:e("TryTrend"),type:2}),c.jsx(tr,{onclick:d})]})]}),c.jsx(Zi,{}),c.jsx(Oi,{}),c.jsx(fi,{isVisible:t})]})}Dn.use(Pn).init({resources:{en:{translation:{paragraphHero1:"Posterfy transforms music passion into visual art.",paragraphHero2:"Create custom posters for your favorite albums using Spotify API.",anchorArt:"Art.",ArtTitle:`Watch the music
