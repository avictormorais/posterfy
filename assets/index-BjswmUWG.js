...
`,go=()=>{const[e,t]=g.useState(null),[r,d]=g.useState(!1),[n,a]=g.useState(!1),[o,s]=g.useState(null);g.useEffect(()=>{const f=()=>{d(window.innerWidth<=770),a(window.innerWidth>480&&window.innerWidth<=1200)};return f(),window.addEventListener("resize",f),()=>window.removeEventListener("resize",f)},[]);const l=f=>{s(f),document.body.style.overflow="hidden"},u=()=>{s(null),document.body.style.overflow="auto"};return c.jsxs(c.Fragment,{children:[c.jsx(uo,{children:co.map((f,h)=>c.jsx(fo,{index:h,isHovered:e===h,hoveredIndex:e,otherIsHovered:e!==null,isMobile:r,isTablet:n,onMouseEnter:()=>t(h),onMouseLeave:()=>t(null),onClick:()=>l(f.coverImage||"/placeholder.svg"),children:c.jsx("img",{src:f.coverImage||"/placeholder.svg",alt:`${f.artist} - ${f.title}`})},f.id))}),o&&c.jsx(ho,{onClick:u,children:c.jsxs(po,{onClick:f=>f.stopPropagation(),children:[c.jsx(mo,{onClick:u,children:"×"}),c.jsx("img",{src:o,alt:"Album cover"})]})})]})},xo=p.div`
  display: flex;
  width: 100%;
  justify-content: center;
  align-items: center;
...
`,bo=()=>c.jsx(xo,{children:c.jsx(go,{})}),vo=p.div`
    width: 100%;
    display: flex;
...
`,ko=p.h3`
    ...
    margin-inline: auto;
    margin-block: 10px;
`;function lt({text:e,type:t}){return c.jsx(c.Fragment,{children:t==1?c.jsx(To,{children:e}):c.jsx(ko,{children:e})})}const Io=p.div`
    width: 80%;
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;function Pn(){const{t:e}=X();return c.jsxs(Ii,{children:[c.jsx(Ei,{}),c.jsx(Si,{children:e("Loading")}),c.jsx(Ri,{children:e("LoadingText")})]})}const Oi=p.div`
    width: 81%;
    display: grid;
...
`,Li=p.p`
    ...
    margin-block: 10px;
    margin-inline: 10px;
`;function se({q:e,a:t}){const[r,d]=g.useState(!1);function n(){d(!r)}return c.jsxs(c.Fragment,{children:[c.jsxs(Pi,{onClick:n,children:[c.jsx(zi,{showA:r}),c.jsx(Mi,{children:e})]}),c.jsx(Fi,{}),c.jsx($i,{showA:r,children:c.jsx(Li,{showA:r,children:t})})]})}const qi=p.div`
    width: 100%;
    margin-inline: auto;
    display: flex;
    flex-direction: column;
...
`,Ni=p.input`
    ...
    border-radius: 7px;
    outline: none;
`;function K({title:e,value:t,onChange:r}){return c.jsxs(Bi,{children:[c.jsx(Qi,{children:e}),c.jsx(Ni,{placeholder:e,value:t,onChange:r})]})}const Gi=p.div`
    display: flex;
    flex-direction: column;
    margin: 10px;
`,Wi=p.input`
...
`,Vi=p.input`
    ...
    border-radius: 7px;
    outline: none;
`;function en({title:e,value:t,onChangeTitle:r,onChangeDate:d}){return c.jsxs(Gi,{children:[c.jsx(Wi,{placeholder:e,value:e,onChange:r}),c.jsx(Vi,{placeholder:e,value:t,onChange:d})]})}const Yi=p.div`
    display: flex;
    flex-direction: column;
    margin: 10px;
`,Ki=p.p`
...
`,ka=p.img`
    ...
    -o-user-drag: none;
    cursor: crosshair;
`;function Ia({DefaultColor:e,image:t,predefinedColors:r,position:d,onDone:n,onClose:a}){const[o,s]=g.useState(e),[l,u]=g.useState(!1),f=g.useRef(null),h=g.useRef(null);function x(){u(!l)}function _(m){s(m.target.value===""?"#":m.target.value)}function b(m){const w=f.current,T=h.current.getBoundingClientRect(),v=w.getContext("2d"),j=m.clientX-T.left,I=m.clientY-T.top,S=`#${[...v.getImageData(j,I,1,1).data].slice(0,3).map(R=>R.toString(16).padStart(2,"0")).join("")}`;s(S),x()}return c.jsxs(xa,{style:{position:"absolute",top:d.top,left:d.left,zIndex:1e3},children:[c.jsx("canvas",{ref:f,style:{display:"none"}}),l?c.jsx(ka,{ref:h,crossOrigin:"anonymous",draggable:"false",src:t,onClick:b,onLoad:()=>{const m=f.current,w=m.getContext("2d"),C=h.current;m.width=C.width,m.height=C.height,w.drawImage(C,0,0,C.width,C.height)}}):c.jsx(ba,{color:o,onChange:s}),c.jsx(Xe,{children:r.map(m=>c.jsx(va,{style:{backgroundColor:m},onClick:()=>s(m)},m))}),c.jsxs(Xe,{children:[c.jsx(ya,{children:"Hex"}),c.jsx(wa,{value:o,onChange:_})]}),c.jsxs(Xe,{children:[l?c.jsx(Ca,{onClick:x}):c.jsx(_a,{onClick:x}),c.jsx(ja,{onClick:a}),c.jsx(Ta,{onClick:()=>{n(o),Lr(o)}})]})]})}const Sa=p.div`
    display: flex;
    flex-direction: column;
    margin: 10px;
`,Ra=p.p`
