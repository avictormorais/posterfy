...
18. Yours`,color1:"#86939b",color2:"#6a5f59",color3:"#81735d",albumID:"4BbsHmXEghoPPevQjPnHXx",userAdjustedTitleSize:!1,initialTitleSizeSet:!0}},{id:5,coverImage:la,JSONConfig:{albumCover:"https://i.scdn.co/image/ab67616d0000b273fbc71c99f9c1296c56dd51b6",uncompressedAlbumCover:"",useUncompressed:!1,albumName:"",artistsName:"",titleSize:"200",artistsSize:"110",tracksSize:"70",marginTop:"-200",marginSide:"115",marginCover:0,marginBackground:0,titleRelease:"Release date",releaseDate:"1991-09-26",titleRuntime:"Runtime",runtime:"49min 15s",backgroundColor:"#0064b0",textColor:"#01010e",useWatermark:!0,useFade:!1,showTracklist:!0,tracklist:`1. Smells Like Teen Spirit
2. In Bloom
3. Come As You Are
4. Breed
5. Lithium
...
13. Endless, Nameless`,color1:"#a6b6ba",color2:"#43bdd1",color3:"#052a5e",albumID:"2UJcKiJxNryhL050F5Z1Fk",userAdjustedTitleSize:!1,initialTitleSizeSet:!0}}],da=h.div`
  display: flex;
  justify-content: center;
  align-items: center;
  width: 100%;
...
`,xa=({onRecreate:e})=>{const{t}=q(),[o,l]=g.useState(null),[r,s]=g.useState(!1),[a,d]=g.useState(!1),[c,u]=g.useState(null),[f,p]=g.useState(null);g.useEffect(()=>{const m=()=>{s(window.innerWidth<=770),d(window.innerWidth>480&&window.innerWidth<=1200)};return m(),window.addEventListener("resize",m),()=>window.removeEventListener("resize",m)},[]);const b=(m,_)=>{u(m),p(_),document.body.style.overflow="hidden"},C=()=>{u(null),document.body.style.overflow="auto"},y=()=>{u(null),e(f),document.body.style.overflow="auto"};return n.jsxs(n.Fragment,{children:[n.jsx(da,{children:ca.map((m,_)=>n.jsx(ua,{index:_,isHovered:o===_,hoveredIndex:o,otherIsHovered:o!==null,isMobile:r,isTablet:a,onMouseEnter:()=>l(_),onMouseLeave:()=>l(null),onClick:()=>b(m.coverImage||"/placeholder.svg",m.JSONConfig),children:n.jsx("img",{src:m.coverImage||"/placeholder.svg",alt:`${m.artist} - ${m.title}`})},m.id))}),c&&n.jsx(fa,{onClick:C,children:n.jsxs(ha,{onClick:m=>m.stopPropagation(),children:[n.jsxs(pa,{children:[n.jsx(ma,{onClick:C,children:"×"}),n.jsx(ga,{onClick:y,children:t("RecreatePoster")})]}),n.jsx("img",{src:c,alt:"Album cover"})]})})]})},va=h.div`
  display: flex;
  width: 100%;
  justify-content: center;
  align-items: center;
...
`,ba=({onRecreate:e})=>n.jsx(va,{children:n.jsx(xa,{onRecreate:e})}),ya=h.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    align-items: center;
...
`,Ia=h.h3`
    ...
    margin-inline: auto;
    margin-block: 10px;
`;function he({text:e,type:t}){return n.jsx(n.Fragment,{children:t==1?n.jsx(Sa,{children:e}):n.jsx(Ia,{children:e})})}const Ma=h.div`
    width: 80%;
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`,un=h.div`
    display: flex;
`;function jt({title:e,paragraph:t}){return n.jsxs(Ma,{children:[n.jsx(un,{children:n.jsx(za,{children:e})}),n.jsx(un,{children:n.jsx(Ra,{children:t})})]})}const Ea=N`
    0% { transform: scale(1); }
...
`,Da=h.div`
    ...
    animation: ${e=>e.initialFade?Oa:"none"} 0.5s ease-in;
`,Ha=h.div`
    animation: ${e=>e.isExiting?Aa:Ea} ${e=>e.isExiting?"0.8s":"0s"} ${e=>e.isExiting?"ease-out forwards":"infinite"};
`;function Pa({isVisible:e,initialFade:t=!1}){const{theme:o}=Be(),[l,r]=g.useState(!1),[s,a]=g.useState(!1);return g.useEffect(()=>{!e&&!l&&(r(!0),setTimeout(()=>{a(!0)},800))},[e,l]),n.jsx(Da,{isVisible:e,fadeOutContainer:s,initialFade:t,children:n.jsx(Ha,{isExiting:l,children:n.jsx(fe,{fill:"var(--AccentColor)",width:"100px",height:"118.23px"})})})}const La=N`
...
`;function ni(){const{t:e}=q(),{theme:t,setSpecificTheme:o}=Be(),l=a=>{o(a)},r=[{id:"light",name:"Light",color:"#f0efeb",icon:n.jsx(nr,{}),isLight:!0},{id:"dark",name:"Dark",color:"#070815",icon:n.jsx(er,{}),isLight:!1},{id:"fy",name:"Midnight",color:"#151515",icon:n.jsx(Oo,{}),isLight:!1},{id:"rose",name:"Rose",color:"#232136",icon:n.jsx(Kn,{}),isLight:!1},{id:"carmesin",name:"Crimson",color:"#1f0c19",icon:n.jsx(Jn,{}),isLight:!1},{id:"brown",name:"Earth",color:"#1e1516",icon:n.jsx(tr,{}),isLight:!1}],s=new Date().getFullYear();return n.jsxs(Ba,{children:[n.jsx("div",{style:{position:"absolute",left:"-10000px",top:"auto",width:"1px",height:"1px",overflow:"hidden"},children:n.jsxs("footer",{children:[n.jsx("h4",{children:"Album Poster Generator Links"}),n.jsxs("nav",{children:[n.jsx("a",{href:"https://posterfy.space",children:"Free Album Poster Maker"}),n.jsx("a",{href:"https://posterfy.space#poster-generator",children:"Create Music Posters"}),n.jsx("a",{href:"https://posterfy.space#faq",children:"Album Poster FAQ"})]}),n.jsx("p",{children:"Posterfy is the best free album poster generator online. Create custom music posters from Spotify albums instantly. No signup required for our album poster maker."}),n.jsx("address",{children:"Contact: Posterfy Album Poster Generator Website: https://posterfy.space Keywords: album poster generator, music poster maker, spotify poster, free poster creator"})]})}),n.jsxs(Va,{children:[n.jsxs(Ua,{children:[n.jsxs(qa,{children:[n.jsx(Qa,{className:"icon-shadow"}),n.jsx(Na,{className:"icon-main",children:n.jsx(fe,{fill:t==="light"?"#2c2929":"white",width:"100px",height:"88.1px"})})]}),n.jsx(Ga,{children:n.jsxs("div",{className:"credit-content",children:[e("MadeBy")," ",n.jsx("a",{href:"https://github.com/avictormorais",target:"blank",children:"Victor"})]})}),n.jsxs(Wa,{children:[n.jsx(Xn,{})," © ",s," Posterfy. ",e("AllRights","All rights reserved.")]})]}),n.jsx(Ya,{children:n.jsx(Za,{children:r.map(a=>n.jsxs(Ja,{children:[n.jsx(Ka,{color:a.color,active:t===a.id,themeId:a.id,onClick:()=>l(a.id),"aria-label":`${e("SwitchTo","Switch to")} ${a.name} ${e("Theme").toLowerCase()}`,children:a.icon},a.id),n.jsx(Xa,{active:t===a.id,children:a.name})]},a.id))})}),n.jsx(ei,{children:n.jsxs(ti,{href:"https://github.com/avictormorais/posterfy",target:"blank",children:[n.jsx(Ro,{})," ",e("ViewGitHub","GitHub")]})})]})]})}function ri(e){return H({attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"},child:[]}]})(e)}function oi(e){return H({attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M416 199.5h-91.4V64H187.4v135.5H96l160 158.1 160-158.1zM96 402.8V448h320v-45.2H96z"},child:[]}]})(e)}const ai=h.div`
    width: 100%;
    display: flex;
    flex-direction: row;
    align-items: center;
...
`,di=h.p`
    ...
    margin-block: 10px;
    margin-inline: 10px;
`;function se({q:e,a:t}){const[o,l]=g.useState(!1);function r(){l(!o)}return n.jsxs(n.Fragment,{children:[n.jsxs(ai,{onClick:r,children:[n.jsx(ii,{showA:o}),n.jsx(si,{children:e})]}),n.jsx(li,{}),n.jsx(ci,{showA:o,children:n.jsx(di,{showA:o,children:t})})]})}const ui=h.div`
    width: 100%;
    margin-inline: auto;
    display: flex;
    flex-direction: column;
...
`,Ti=h.div`
    ...
    backdrop-filter: blur(10px);
    z-index: 1000;
    animation: ${e=>e.isClosing?ji:ki} 0.3s ease-in-out forwards;
`,Si=h.div`
    background-color: var(--backgroundColor);
    width: 30%;
    min-width: 250px;
    ...
    animation: ${e=>e.isClosing?_i:Ci} 0.3s ease-in-out forwards;
...
`;function ds(){var s,a,d;const{i18n:e}=q(),{t}=q(),o=((s=e.language)==null?void 0:s.split("-")[0])||"en",l=pn.filter(c=>c.key!=="contribute_area"),r=pn.find(c=>c.key==="contribute_area");return n.jsxs(Xi,{id:"thanks",children:[n.jsx(he,{text:t("Thanks"),type:1}),l.map((c,u)=>n.jsxs(es,{children:[n.jsxs(ts,{children:[n.jsx(ns,{className:"circle"}),n.jsx(rs,{className:"heart"}),n.jsx(os,{tabIndex:0,role:"button",onClick:()=>window.open(c.url,"_blank","noopener,noreferrer"),onKeyDown:f=>{(f.key==="Enter"||f.key===" ")&&window.open(c.url,"_blank","noopener,noreferrer")},onMouseEnter:f=>{const p=f.target.parentNode;p.querySelector(".circle").style.opacity=0,p.querySelector(".heart").style.opacity=1},onMouseLeave:f=>{const p=f.target.parentNode;p.querySelector(".circle").style.opacity=.8,p.querySelector(".heart").style.opacity=0},children:c.title[o]||c.title.en})]}),n.jsx(as,{children:c.text[o]||c.text.en})]},c.key)),r&&n.jsxs(is,{children:[n.jsx(ss,{children:r.title[o]||r.title.en}),n.jsx(ls,{children:r.text[o]||r.text.en}),n.jsx(cs,{href:r.url,target:"_blank",rel:"noopener noreferrer",children:((a=r.button)==null?void 0:a[o])||((d=r.button)==null?void 0:d.en)||"Github"})]})]})}const us=h.div`
    display: flex;
    flex-direction: column;
    margin: 10px;
`,fs=h.p`
